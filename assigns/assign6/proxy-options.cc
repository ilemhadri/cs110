 ...
 * -----------------------------------
 * Uses the loggedin user ID to generate a port number between 2000
 * and 49150 inclusive.  The idea to hash the loggedinuser ID to
...
static const unsigned short kHighestOpenPortNumber = 49150;
unsigned short computeDefaultPortForUser() {
  ...
  return hashValue % (kHighestOpenPortNumber - kLowestOpenPortNumber) + kLowestOpenPortNumber;
}
