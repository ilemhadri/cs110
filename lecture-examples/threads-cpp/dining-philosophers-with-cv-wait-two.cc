/**
 * File: dining-philosophers-with-cv-wait-two.cc
 * ---------------------------------------------
 * This program implements the classic dining philosophers
 * simulation.  This version is functionally equivalent to the
 * one presented in dining-philosophers-with-cv-wait-two.cc, except
 * that it uses a better version of condition_variable_any::wait.
 */
